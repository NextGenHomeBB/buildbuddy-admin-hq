...
create policy "owner managers create invites"
...
create policy "owner members read invites"
  on public.project_invites
  for select
  to authenticated
  using (
...
create policy "invited user reads own invites"
  on public.project_invites
  for select
  to authenticated
  using (
...
create policy "owner managers delete invites"
  on public.project_invites
  for delete
  to authenticated
  using (
...
create policy "owner managers update invites"
  on public.project_invites
  for update
  to authenticated
  using (
...
create policy "invited user accepts invite"
  on public.project_invites
  for update
  to authenticated
  using (
